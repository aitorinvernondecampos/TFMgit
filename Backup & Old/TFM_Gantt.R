...
package_list <- c("knitr", "tidyverse", "RColorBrewer", "kableExtra", "scales", "ganttrify", "tidyverse", "egg", "ggpp")
...
end_date <- as.Date(c('2023-10-01', # "PEC1 - Definición y plan de trabajo"
                      ...
                      '2023-11-21', # "PEC2 - Desarrollo del trabajo (Fase 1)"
                      '2023-11-30', # "PEC3 - Desarrollo del trabajo (Fase 2)"
                      '2023-12-10', # "PEC3 - Desarrollo del trabajo (Fase 2)"
                      '2023-12-17', # "PEC3 - Desarrollo del trabajo (Fase 2)"
                      '2023-12-17', # "PEC3 - Desarrollo del trabajo (Fase 2)"
                      '2023-12-17', # "PEC3 - Desarrollo del trabajo (Fase 2)"
                      '2023-12-19', # "PEC3 - Desarrollo del trabajo (Fase 2)"
                      '2023-12-19', # "PEC3 - Desarrollo del trabajo (Fase 2)"
                      '2024-01-10', # "PEC4 - Cierre de la memoria y presentación"
...
status <- c('C', # "PEC1 - Definición y plan de trabajo"
            ...
            'C', # "PEC1 - Definición y plan de trabajo"
            'C', # "PEC1 - Definición y plan de trabajo"
            'I', # "PEC2 - Desarrollo del trabajo (Fase 1)"
            'I', # "PEC2 - Desarrollo del trabajo (Fase 1)"
            'I', # "PEC2 - Desarrollo del trabajo (Fase 1)"
            'I', # "PEC2 - Desarrollo del trabajo (Fase 1)"
            'I', # "PEC2 - Desarrollo del trabajo (Fase 1)"
...
spot_date <- as.Date(c('2023-09-28', # "PEC1 - Definición y plan de trabajo"
                       ...
                       '2023-11-21', # "PEC2 - Desarrollo del trabajo (Fase 1)"
                       '2023-11-26', # "PEC3 - Desarrollo del trabajo (Fase 2)"
                       '2023-12-03', # "PEC3 - Desarrollo del trabajo (Fase 2)"
                       '2023-12-10', # "PEC3 - Desarrollo del trabajo (Fase 2)"
                       '2023-12-14', # "PEC3 - Desarrollo del trabajo (Fase 2)"
                       '2023-12-15', # "PEC3 - Desarrollo del trabajo (Fase 2)"
                       '2023-12-18', # "PEC3 - Desarrollo del trabajo (Fase 2)"
                       '2023-12-19', # "PEC3 - Desarrollo del trabajo (Fase 2)"
